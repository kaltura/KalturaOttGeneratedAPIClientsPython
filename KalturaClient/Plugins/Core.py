...
# @package Kaltura
# @subpackage Client
class KalturaReminderOrderBy(object):
    NONE = "NONE"
...
class KalturaAssetService(KalturaServiceBase):
    ...
    def count(self, groupBy, filter = NotImplemented):
        ...
        kparams = KalturaParams()
        kparams.addArrayIfDefined("groupBy", groupBy)
        kparams.addObjectIfDefined("filter", filter)
...
class KalturaCoreClient(KalturaClientPlugin):
    ...
    def getEnums(self):
        return {
            ...
            'KalturaReminderOrderBy': KalturaReminderOrderBy,
