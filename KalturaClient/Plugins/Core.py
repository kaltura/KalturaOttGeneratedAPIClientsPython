...
class KalturaMessageTemplate(KalturaObjectBase):
    ...
    PROPERTY_LOADERS = {
        ...
        'messageType': (KalturaEnumsFactory.createInt, "KalturaMessageTemplateType"), 
    ...
    def toParams(self):
        ...
        kparams.addIntEnumIfDefined("messageType", self.messageType)
...
class KalturaMessageTemplateService(KalturaServiceBase):
    ...
    def get(self, messageType):
        ...
        kparams = KalturaParams()
        kparams.addIntIfDefined("messageType", messageType);
