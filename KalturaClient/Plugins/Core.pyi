...
class KalturaSubtitles(KalturaObjectBase):
    ...
    def __init__(self,
            ...
            createDate: int = NotImplemented,
            fileName: str = NotImplemented,
            subtitlesType: KalturaSubtitlesType = NotImplemented,
            subtitlesLanguage: str = NotImplemented): ...

    def getId(self) -> int: ...
    def getCreateDate(self) -> int: ...
    def getFileName(self) -> str: ...
    def setFileName(self, newFileName: str) -> None: ...
    def getSubtitlesType(self) -> KalturaSubtitlesType: ...
    def setSubtitlesType(self, newSubtitlesType: KalturaSubtitlesType) -> None: ...
    def getSubtitlesLanguage(self) -> str: ...
    def setSubtitlesLanguage(self, newSubtitlesLanguage: str) -> None: ...
...
class KalturaAiMetadataGeneratorService(KalturaServiceBase):
    def generateMetadataBySubtitles(self, subtitlesFileId: int, externalAssetIds: List[None]) -> KalturaGenerateMetadataBySubtitlesJob: ...
...
class KalturaSubtitlesService(KalturaServiceBase):
    def get(self, id: int) -> KalturaSubtitles: ...
    def list(self, filter: KalturaSubtitlesFilter, pager: KalturaFilterPager) -> KalturaSubtitlesListResponse: ...
    def uploadFile(self, subtitles: KalturaSubtitles, file: IO[Any]) -> KalturaSubtitles: ...
