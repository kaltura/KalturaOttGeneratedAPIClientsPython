...
class KalturaAiMetadataGeneratorService(KalturaServiceBase):
    def generateMetadataBySubtitles(self, subtitlesFileId: int, externalAssetIds: List[None] = NotImplemented) -> KalturaGenerateMetadataBySubtitlesJob: ...
    def getGeneratedMetadata(self, jobId: int) -> KalturaGenerateMetadataResult: ...
    def getGenerateMetadataJob(self, id: int) -> KalturaGenerateMetadataBySubtitlesJob: ...
