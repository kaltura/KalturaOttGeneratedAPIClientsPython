...
class KalturaSubtitles(KalturaObjectBase):
    ...
    def __init__(self,
            ...
            createDate: int = NotImplemented,
            fileName: str = NotImplemented,
            type: KalturaSubtitlesType = NotImplemented,
            language: str = NotImplemented): ...
    ...
    def getType(self) -> KalturaSubtitlesType: ...
    def setType(self, newType: KalturaSubtitlesType) -> None: ...
    def getLanguage(self) -> str: ...
    def setLanguage(self, newLanguage: str) -> None: ...
...
class KalturaSubtitlesService(KalturaServiceBase):
    ...
    def uploadFile(self, subtitles: KalturaSubtitles, fileData: IO[Any]) -> KalturaSubtitles: ...
