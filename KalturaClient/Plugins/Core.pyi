...
class KalturaAiMetadataGeneratorConfiguration(KalturaObjectBase):
    assetStructMetaNameMap: map
    supportedLanguages: List[KalturaStringValue]
    def __init__(self,
            assetStructMetaNameMap: map = NotImplemented,
            supportedLanguages: List[KalturaStringValue] = NotImplemented): ...

    def getAssetStructMetaNameMap(self) -> map: ...
    def setAssetStructMetaNameMap(self, newAssetStructMetaNameMap: map) -> None: ...
...
class KalturaStreamingDeviceService(KalturaServiceBase):
    def bookPlaybackSession(self, fileId: str, assetId: str, assetType: str, programId: int = NotImplemented) -> bool: ...
