...
class KalturaSearchableAttribute(KalturaObjectBase):
    ...
    attributes: str
    def __init__(self,
            assetStructId: str = NotImplemented,
            attributes: str = NotImplemented): ...

    def getAssetStructId(self) -> str: ...
    def setAssetStructId(self, newAssetStructId: str) -> None: ...
...
class KalturaSemanticAssetSearchPartnerConfigService(KalturaServiceBase):
    ...
    def getSearchableAttributes(self, assetStructId: str) -> KalturaSearchableAttributes: ...
