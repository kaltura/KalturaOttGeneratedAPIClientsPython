...
class KalturaBulkPlaybackContextResponse(KalturaListResponse):
    objects: List[KalturaBulkResponseObject]
    def __init__(self,
            totalCount: int = NotImplemented,
            objects: List[KalturaBulkResponseObject] = NotImplemented): ...

    def getObjects(self) -> List[KalturaBulkResponseObject]: ...
    def setObjects(self, newObjects: List[KalturaBulkResponseObject]) -> None: ...
