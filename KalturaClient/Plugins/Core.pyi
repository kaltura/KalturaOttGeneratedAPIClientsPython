...
class KalturaMetaFieldNameMap(KalturaObjectBase):
    ...
    def __init__(self,
            ...
            shortDescription: str = NotImplemented,
            longDescription: str = NotImplemented,
    ...
    def setShortDescription(self, newShortDescription: str) -> None: ...
    def getLongDescription(self) -> str: ...
    def setLongDescription(self, newLongDescription: str) -> None: ...
