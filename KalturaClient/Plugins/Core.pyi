...
class KalturaBulkPlaybackContextResponse(KalturaListResponse):
    objects: List[KalturaBulkResponseItem]
    def __init__(self,
            totalCount: int = NotImplemented,
            objects: List[KalturaBulkResponseItem] = NotImplemented): ...

    def getObjects(self) -> List[KalturaBulkResponseItem]: ...
    def setObjects(self, newObjects: List[KalturaBulkResponseItem]) -> None: ...
