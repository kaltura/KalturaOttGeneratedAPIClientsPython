...
class KalturaBulkPlaybackContext(KalturaObjectBase):
    playbackContexts: List[KalturaPlaybackContext]
    def __init__(self,
            playbackContexts: List[KalturaPlaybackContext] = NotImplemented): ...

    def getPlaybackContexts(self) -> List[KalturaPlaybackContext]: ...
    def setPlaybackContexts(self, newPlaybackContexts: List[KalturaPlaybackContext]) -> None: ...
...
class KalturaAssetService(KalturaServiceBase):
    ...
    def getBulkPlaybackContext(self, fileTypes: List[None], streamerType: str, context: str, urlType: str) -> KalturaBulkPlaybackContext: ...
