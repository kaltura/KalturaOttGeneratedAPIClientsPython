...
class KalturaTreeQuestion(KalturaObjectBase):
    ...
    text: str
    level: int
    metadataTypes: List[KalturaStringValue]
    def __init__(self,
            questionId: str = NotImplemented,
            text: str = NotImplemented,
            level: int = NotImplemented,
            metadataTypes: List[KalturaStringValue] = NotImplemented): ...
    ...
    def getMetadataTypes(self) -> List[KalturaStringValue]: ...
    def setMetadataTypes(self, newMetadataTypes: List[KalturaStringValue]) -> None: ...
...
class KalturaTreeAnswer(KalturaObjectBase):
    ...
    def __init__(self,
            ...
            text: str = NotImplemented,
            hasNextQuestion: bool = NotImplemented,
            isSpecial: bool = NotImplemented,
            specialType: str = NotImplemented): ...

    def getAnswerId(self) -> str: ...
    def setAnswerId(self, newAnswerId: str) -> None: ...
    def getText(self) -> str: ...
    def setText(self, newText: str) -> None: ...
    def getHasNextQuestion(self) -> bool: ...
    def setHasNextQuestion(self, newHasNextQuestion: bool) -> None: ...
    def getIsSpecial(self) -> bool: ...
    def setIsSpecial(self, newIsSpecial: bool) -> None: ...
...
class KalturaAiRecommendationTreeService(KalturaServiceBase):
    def getNextNodeAndRecommendation(self, treeId: str = NotImplemented, previousQuestionId: str = NotImplemented, answerId: str = NotImplemented, topQuestionId: str = NotImplemented) -> KalturaTreeNextNodeResponse: ...
    def getPartnerConfig(self) -> KalturaAiRecommendationTreePartnerConfiguration: ...
    def getRecommendationWithNaturalText(self, naturalTextQuery: str, previousQuestionId: str = NotImplemented, treeId: str = NotImplemented) -> KalturaTreeNaturalTextResponse: ...
