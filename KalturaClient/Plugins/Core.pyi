...
class KalturaSearchType(object):
    UNKNOWN = "Unknown"
    ASSET = "Asset"
    PROGRAM = "Program"
...
class KalturaSearchCondition(KalturaObjectBase):
    field: str
...
class KalturaSearchScope(KalturaObjectBase):
    type: KalturaSearchType
    filters: List[KalturaSearchCondition]
    def __init__(self,
            type: KalturaSearchType = NotImplemented,
            filters: List[KalturaSearchCondition] = NotImplemented): ...

    def getType(self) -> KalturaSearchType: ...
    def setType(self, newType: KalturaSearchType) -> None: ...
    def getFilters(self) -> List[KalturaSearchCondition]: ...
    def setFilters(self, newFilters: List[KalturaSearchCondition]) -> None: ...
...
class KalturaAssetService(KalturaServiceBase):
    ...
    def unifiedSemanticSearch(self, query: str, searchScopes: List[None], refineQuery: bool = False, size: int = 10) -> KalturaAssetListResponse: ...
