...
class KalturaGenerateMetadataByDescription(KalturaObjectBase):
    ...
    def __init__(self,
            externalAssetId: KalturaStringValue = NotImplemented): ...

    def getExternalAssetId(self) -> KalturaStringValue: ...
    def setExternalAssetId(self, newExternalAssetId: KalturaStringValue) -> None: ...
