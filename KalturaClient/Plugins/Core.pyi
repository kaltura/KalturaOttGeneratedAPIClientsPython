...
class KalturaAssetService(KalturaServiceBase):
    ...
    def semanticSearch(self, query: str, refineQuery: bool = False, size: int = 10) -> KalturaAssetListResponse: ...
    def unifiedSemanticSearch(self, searchParams: KalturaSemanticSearchParams) -> KalturaAssetListResponse: ...
...
class KalturaSemanticAssetSearchPartnerConfigService(KalturaServiceBase):
    ...
    def getProgramSearchableAttributes(self) -> str: ...
    ...
    def upsertProgramSearchableAttributes(self, programAttributes: str) -> str: ...
