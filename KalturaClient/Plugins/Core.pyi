...
class KalturaTreeRecommendations(KalturaObjectBase):
    title: str
    searchQuery: str
    assetIds: List[KalturaStringValue]
    def __init__(self,
            title: str = NotImplemented,
            searchQuery: str = NotImplemented,
            assetIds: List[KalturaStringValue] = NotImplemented): ...

    def getTitle(self) -> str: ...
    def setTitle(self, newTitle: str) -> None: ...
    def getSearchQuery(self) -> str: ...
    def setSearchQuery(self, newSearchQuery: str) -> None: ...
    def getAssetIds(self) -> List[KalturaStringValue]: ...
    def setAssetIds(self, newAssetIds: List[KalturaStringValue]) -> None: ...
...
class KalturaAiRecommendationTreePartnerConfiguration(KalturaObjectBase):
    activeMetadataTypes: List[KalturaStringValue]
    topLevelQuestions: int
    answersPerQuestion: int
    levels: int
    specialAnswers: bool
    numOfRecommendedAssets: int
    removeWatchedRecommendations: bool
    treeGenerationFrequency: str
    modelId: str
    activeTreeId: str
    def __init__(self,
            activeMetadataTypes: List[KalturaStringValue] = NotImplemented,
            ...
            removeWatchedRecommendations: bool = NotImplemented,
            treeGenerationFrequency: str = NotImplemented,
            modelId: str = NotImplemented,
            activeTreeId: str = NotImplemented): ...

    def getActiveMetadataTypes(self) -> List[KalturaStringValue]: ...
    def setActiveMetadataTypes(self, newActiveMetadataTypes: List[KalturaStringValue]) -> None: ...
    ...
    def getRemoveWatchedRecommendations(self) -> bool: ...
    def setRemoveWatchedRecommendations(self, newRemoveWatchedRecommendations: bool) -> None: ...
    ...
    def setModelId(self, newModelId: str) -> None: ...
...
class KalturaAiRecommendationTreeService(KalturaServiceBase):
    def getNextNodeAndRecommendation(self, treeId: str = NotImplemented, previousQuestionId: str = NotImplemented, answerId: str = NotImplemented, topQuestion: str = NotImplemented) -> KalturaTreeNextNodeResponse: ...
